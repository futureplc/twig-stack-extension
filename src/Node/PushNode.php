...
{
    public function __construct(string $stackName, Node $body, int $lineno = 0, bool $pushOnce = false)
    {
        parent::__construct(['body' => $body], ['name' => $stackName, 'once' => $pushOnce], $lineno);
    }
